...
export const APP_NAME: string = (pkg as { name: string }).name;

export const GITHUB_REPO_URL: string = (pkg as { repository: { url: string } })
  .repository.url;

export const CONFIG_DIR: string = path.join(os.homedir(), `.${APP_NAME}`);
