 ...
 * @group Core Modules
 */
export interface CoreFileSystemInterface {
 ...
 * @group Core Modules
 */
export interface FilesClaudeContextStatus {
 ...
 */
class DefaultFileSystem implements CoreFileSystemInterface {
...
export async function validateFileStructure(
  projectPath: string,
  fileSystem: CoreFileSystemInterface = defaultFileSystem,
...
async function checkFileExists(
  filePath: string,
  fileSystem: CoreFileSystemInterface,
): Promise<boolean> {
  try {
...
export async function ensureClaudeContext(
  ...
  const status: FilesClaudeContextStatus = {
    isComplete: false,
